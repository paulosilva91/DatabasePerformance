...
class DataLoaderSqlite(context: Context, performanceTestResultListener: IPerformanceTestResultListener) : BaseLoader<DataSqlite>() {
    ...
    init {
        initSqlite()
        setDatabasePerformanceTestResultListener(performanceTestResultListener)
    }
